...
class AspActivity : AppCompatActivity() {
    ...
    // Later change this URL to the one that we will be using!!!
    private val postURL: String = "http://10.0.2.2:5000/api/Image"
    ...
    private fun uploadImage() {
        ...
        val request = object : VolleyFileUploadRequest(
            ...
            override fun getByteData(): MutableMap<String, FileDataPart> {
                ...
                params["file"] = FileDataPart("image"+System.currentTimeMillis()+".jpg", imageData!!, "jpeg")
                return params
            }
        }
